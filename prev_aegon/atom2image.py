...
#------------------------------------------------------------------------------------------
Width=1200 #6000 #1600
Height=900 #4500 #1200
fd=2.8
bwd='0.15'                    # 0.15 GRUESO DE LOS ENLACES
...
radio_factor=float(1.5)       # 1.4 1.6 #ALCANCE DE LOS ENLACES
tmit = 0.35                   # transmit (transparencia) 0.35 0.75
#-----------------------------------------------------------------------------------------
def write_image(poscarin, basename, f=fd, w=Width, h=Height):
    ...
    opnew.close()
    comp='povray +A Display=Off Output_File_Type=N All_Console=Off Width='+str(w)+' Height='+str(h)+' '+name_pov+' > /dev/null 2>&1'
    os.system(comp)

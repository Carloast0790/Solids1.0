...
from utils_solids.miscellaneous import pyxtal2solids, rescale_str, unit_cell_non_negative_coordinates,get_symmetry_constrains
...
#------------------------------------------------------------------------------------------------
def random_crystal_gen_SM(revisit_syms,species,atoms_per_specie,p_list,formula_units=1,dimension=3,volume_factor=1.0,vol_restr=False):
